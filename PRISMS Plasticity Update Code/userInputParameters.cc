...
pcout (std::cout, dealii::Utilities::MPI::this_mpi_process(MPI_COMM_WORLD)==0)
{
  ...
  enableDSP = parameter_handler.get_bool("Use DSP Model");
  DSPfilename=parameter_handler.get("DSP CRSS filename");
  DSPheaderlines=parameter_handler.get_integer("DSP file number of header lines");
  stressFactor = parameter_handler.get_double("SaturationStressFactor");
  currentSim = parameter_handler.get_integer("Current Simulation");
  ...
  output_Var1 = parameter_handler.get_bool("Output Total Slip");
...
void userInputParameters::declare_parameters(dealii::ParameterHandler & parameter_handler){
  ...
  parameter_handler.declare_entry("Use DSP Model","false",dealii::Patterns::Bool(),"Flag to indicate whether to use DSP model");
  parameter_handler.declare_entry("DSP CRSS filename","DSPinfo.txt",dealii::Patterns::Anything(),"File name containing DSP information");
  parameter_handler.declare_entry("DSP file number of header lines","1",dealii::Patterns::Integer(),"DSP file number of header lines");
  parameter_handler.declare_entry("SaturationStressFactor","2.0",dealii::Patterns::Double(),"SaturationStressFactor");
  parameter_handler.declare_entry("Current Simulation","0",dealii::Patterns::Integer(),"Current Simulation");
  ...
  parameter_handler.declare_entry("Output Total Slip","false",dealii::Patterns::Bool(),"Output Total Slip");
